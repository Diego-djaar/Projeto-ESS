...
Scenario: Inserir Pix corretamente 
    Given o pix de nome "Breno Gabriel de Melo Lima" e cpf ""
    ...
    And o usuário é direcionando para a página "paymentMethod/inserting"
...
#     Then o usuário visualiza a mensagem "Método de pagamento cadastrado"
#     And o usuário é direcionando para a página "http://localhost:3000/paymentMethod/inserting"
