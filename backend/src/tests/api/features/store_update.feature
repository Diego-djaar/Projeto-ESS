Feature: Manutenção de lojas cadastradas
    ...
    When Uma requisição POST for enviada para "stores/login/retrieve_password", com as seguintes informações (CNPJ: "48.449.992/0001-65", Email: "Hortifruti@loja.com", Nova_senha: "1234")
    ...
    When Uma requisição POST for enviada para "stores/login/retrieve_password", com as seguintes informações (CNPJ: "BrenoMiranda", Email: "Hortifruti@loja.com", Nova_senha: "1234")
    ...
    When Uma requisição POST for enviada para "stores/store_signup", com as seguintes informações (CNPJ: "48.449.992/0001-65", Senha: "htft8", novoNome: "Hortifrutaria", novaCategoria: "Eletronicos")
    Then O status da resposta deve ser "200"
